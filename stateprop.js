...
let websiteurl = "https://www.youtube.com/embed/SIpjQG_d85U?autoplay=1&controls=0"; /* ?autoplay=1&controls=0 For YouTube Live */
...
function enableScreenStuff2() {
  if (screenstuffenabled2 == 0){
	...
	firescreen.setAttribute("position", "0 1.5 -8");
	...
	firescreen.setAttribute("screen-position", "0 -4.5 -0.02");
